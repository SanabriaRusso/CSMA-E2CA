...
set ylabel "Collision probability (Cp)" 
...
GNUTERM = "x11"
plot "collisionsInTime-DCF.txt" u 1:2 title "Cp for CSMA/CA" w l ls 1 lw 2, "collisionsInTime-100.txt" u 1:2 title "Cp for Basic CSMA/ECA" w l ls 3 lw 2, "collisionsInTime-110.txt" u 1:2 title "Cp for CSMA/ECA w/ hysteresis" w l ls 4 lw 2, "collisionsInTime-111.txt" u 1:2 title "Cp for CSMA/ECA w/ hysteresis and fair-share" w l ls 9 lw 2
#    EOF
