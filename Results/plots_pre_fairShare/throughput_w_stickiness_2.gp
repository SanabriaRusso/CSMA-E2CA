...
set y2range [ 0.400000 : 1.50000 ] noreverse nowriteback
set zlabel "" 
...
GNUTERM = "x11"
plot "2_0_0.txt" u 1:2 title "Throughput w stageStickiness = 0" w l ls 1 lw 2 axis x1y1, "" u 1:4 title "Jain's fairness index" w l ls 2 lw 2 axis x1y2, "2_1_0.txt" u 1:2 title "Throughput w stageStickiness = 1" w l ls 3 lw 2 axis x1y1, "" u 1:4 title "Jain's fairness index w stageStickiness = 1" w l ls 4 lw 2 axis x1y2
#    EOF
