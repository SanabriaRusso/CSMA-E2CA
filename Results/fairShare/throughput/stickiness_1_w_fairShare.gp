...
set title "Stickiness 1, stageStickiness 1" 
...
GNUTERM = "x11"
plot "1_1_1.txt" u 1:2 title "Throughput" w l ls 1 lw 2 axis x1y1, "../plots_pre_fairShare/1_1_0.txt" u 1:2 title "Throughput fairShare = 0" w l ls 2 lw 2 axis x1y1, "" u 1:4 title "JFI fairShare = 0" w l ls 3 lw 2 axis x1y2, "1_1_1.txt" u 1:4 title "JFI" w l ls 4 lw 2 axis x1y2
#    EOF
