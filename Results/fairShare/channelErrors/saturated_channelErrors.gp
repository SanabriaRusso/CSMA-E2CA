...
# set output 'saturated_channelErrors.eps'
unset clip points
set clip one
unset clip two
...
set title "Throughput under different % of channel error (11M-2-1-1)" 
...
set yrange [ 4.00000e+06 : 6.60000e+06 ] noreverse nowriteback
