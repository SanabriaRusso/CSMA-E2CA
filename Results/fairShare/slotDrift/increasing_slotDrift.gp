...
set title "Throughput stickiness 2, stageStickiness 1, fairShare 1, channelErrors 0%" 
...
set xlabel "Slot drift probability (%)" 
...
set yrange [ 5.40000e+06 : 8.00000e+06 ] noreverse nowriteback
...
GNUTERM = "x11"
plot "increasing_slotDrift.txt" u 7:2 title "Throughput 2-1-1" w l ls 2 lw 2, "increasing_slotDrift_DCF.txt" u 7:2 title "Throughput DCF" w l ls 3 lw 2
#    EOF
