...
set key noopaque
unset label
set label 1 "Avg. cumm. Tx delay" at 0, 57, 0 left rotate by -270 back nopoint offset character 0, 0, 0
unset arrow
set style increment default
unset style line
set style line 100  linetype -1 linewidth 0.200 pointtype -1 pointsize default pointinterval 0
unset style arrow
...
set title "Stickiness 1, stageStickiness 1, fairShare 1" 
...
GNUTERM = "x11"
splot "delay_1_1_1.txt" u 5:1:6 title "Average cummulative system Tx delay" w pm3d
#    EOF
