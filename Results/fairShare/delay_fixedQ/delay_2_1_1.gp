...
set key noopaque
unset label
set label 1 "Avg. Tx delay" at 0, 55, 20 left rotate by -270 back nopoint offset character 0, 0, 0
unset arrow
...
set title "Stickiness 2, stageStickiness 1, fairShare 1" 
...
GNUTERM = "x11"
splot "delay_2_1_1.txt" u 5:1:6 title "Average system Tx delay" w pm3d
#    EOF
